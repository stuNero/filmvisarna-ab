  ...
  return <>
    <div className="flex items-center justify-between bg-black rounded-lg p-4 border border-white/10">
      ...
      <div className="flex items-center gap-3">
        <button className={totalTickets > 0 && ticketCount > 0 ? `flex justify-center items-center px-4 py-2 text-[10px] size-10 text-stone-500 outline-solid rounded hover:bg-red-600`
          : `flex justify-center items-center px-4 py-2 text-[10px] size-10 text-stone-800 outline-solid rounded`
        } onClick={decrementTicket}>➖</button>
        <p>{ticketCount}</p>
        <button className={totalTickets < 8 ? `flex justify-center items-center px-4 py-2 text-[10px] size-10 text-stone-500 outline-solid rounded hover:bg-red-600`
          : `flex justify-center items-center px-4 py-2 text-[10px] size-10 text-stone-800 outline-solid rounded`
