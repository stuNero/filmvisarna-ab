...
export default function Footer() {
  return <footer className="w-full 
    ...
    <article className='flex flex-col mt-[25px] px-[50px]'>
      <Link to="/" className='flex flex-row red_hover mb-[10px]'>
    ...
    <article className='flex flex-col mt-[25px] px-[50px]'>
      ...
      <Link to={LocaleDetailsPage.route.path} className='opacity-50 hover:opacity-100 red_hover'>
        {LocaleDetailsPage.route.menuLabel}</Link>
      <Link to={KioskInfoPage.route.path} className='opacity-50 hover:opacity-100 red_hover'>
        {KioskInfoPage.route.menuLabel}</Link>
    </article>
    <article className='flex flex-col mt-[25px] px-[50px]'>
      <h1 className='text-lg'>Support:</h1>
      <Link to={CancelBookingPage.route.path} className='opacity-50 hover:opacity-100 red_hover'>
