...
export default function Footer() {
  return <footer className="w-full flex flex-row relative bg-black border-t-2 border-solid border-stone-600 h-[200px] container max-w-7xl mx-auto">
    ...
    <article className='flex flex-col mt-[25px] px-[50px]'>
      ...
      <p className='opacity-50'>Din ultimata destination för de senaste filmerna<br /> och oförglömliga bioupplevelser.</p>
    </article>
    <article className='flex flex-col mt-[25px] px-[50px]'>
